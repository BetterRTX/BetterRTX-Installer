...
from src.files import download_install_BetterRTX_Bins, install_dlss, uninstall_betterrtx, handle_drag_drop_files, uninstall_dlss
...
class MainApp:
    ...
    def __init__(self, page: ft.Page):
        ...
        self.loading_container = ft.Column([
            ft.ProgressRing(),
            ft.Text("Loading packages and presets...", color="white")
        ...
        self.menu_bar = ft.MenuBar(
            ...
            controls=[
                ft.SubmenuButton(
                    ...
                    controls=[
                        ft.SubmenuButton(
                            content=ft.Text("Launchers", color="white"),
                            style=ft.ButtonStyle(
                                bgcolor={ft.ControlState.HOVERED: ft.Colors.ORANGE},
                                shape=ft.RoundedRectangleBorder(radius=0),
                            ),
                            controls=[
                                ft.MenuItemButton(
                                    content=ft.Text("Download MC Launcher", color="white"),
                                ...
                                ft.MenuItemButton(
                                    content=ft.Text("Download Bedrock Launcher", color="white"),
                ...
                ft.SubmenuButton(
                    content=ft.Text("Advanced", color="white"),
                    ...
                    controls=[
                        ...
                        ft.MenuItemButton(
                            content=ft.Text("Uninstall DLSS Update", color={ft.ControlState.DEFAULT: "white", ft.ControlState.DISABLED: ft.Colors.GREY_500}),
    ...
    def update_install_button_state(self):
        ...
        if advanced_submenu and advanced_submenu.controls:
            for item in advanced_submenu.controls:
                if isinstance(item, ft.MenuItemButton) and hasattr(item.content, 'value') and "Uninstall DLSS Update" in item.content.value:
