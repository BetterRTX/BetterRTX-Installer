...
logo11 =  |                                                                             |
logo12 =  |         Das ist v1.1.0 von dem Installationstool für Minecraft RTX          |
logo12prerelease =  | Das ist v1.1.0.3 (Pre-release) von dem Installationstool für Minecraft RTX  |
...
installerLocationChoice2 = 2): Minecraft Preview Edition (Fortgeschritten) (Nicht empfohlen, weil sich Funktionen ändern können, bevor BetterRTX ein neues Update erhält)
installerLocationInvalid = Deine Auswahl ist ungültig!
installerLocationPrompt = Auswahl
...
installationMethod = Wähle bitte deine bevorzugte Installierungsmethode:
serverInstall = 1): BetterRTX von den Servern installieren (Empfohlen)
localInstall = 2): BetterRTX von den lokalen Dateien installieren (Fortgeschritten) (Dafür müssen die neusten Dateien mit dem Installationstool in einem Ordner sein)
uninstall = 3): BetterRTX deinstallieren
exit = 4): Das Installationstool schließen
installationMethodInvalid = Deine Auswahl ist ungültig!
installationMethodPrompt = Auswahl
...
insertingVanillaStub = Die Vanilla RTXStub.material.bin Datei wird in Minecraft hinzugefügt
